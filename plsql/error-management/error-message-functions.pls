...
or the system error message associated with the specified error code. DBMS_UTILITY.FORMAT_ERROR_STACK also 
returns the error message (or stack, if there is a stack of errors) and avoids truncation issues that may occur with SQLERRM.

LiveSQL link: https://livesql.oracle.com/apex/livesql/file/content_CSHKGPS5AHKCMUIAYYMTL1QYT.html
*/
