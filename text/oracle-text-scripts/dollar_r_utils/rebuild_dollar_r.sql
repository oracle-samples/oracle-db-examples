-- CTXREBUILD package
-- This package rebuilds the $R table from the $K table
-- THIS VERSION HARD CODES THE ROW SIZE TO 35K ROWIDS (490000 bytes)
--
...
drop public synonym ctx_rebuild;
drop package ctx_rebuild;
...
-- CTX DIAGnostics
create package ctx_rebuild authid current_user as
...
-- CTX DIAGnostics
create package body ctx_rebuild as
...
grant execute on ctx_rebuild to public;
create public synonym ctx_rebuild for ctx_rebuild;
