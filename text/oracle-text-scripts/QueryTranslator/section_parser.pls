...
begin
  ...
  loop 
    exit when closeCount = openCount or pos > length(inputStr);
...
procedure sectionSplitter (query varchar2, retList in out subqListType ) is
...
begin
  ...
  sectionSplitter( userStr, sectionQrys );  -- to do - validate sections?
