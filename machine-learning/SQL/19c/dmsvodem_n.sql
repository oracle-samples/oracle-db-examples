Rem
Rem $Header: tk_datamining/tmdm/sql/dmsvodem_n.sql /main/8 2016/08/16 23:01:15 madhpand Exp $
Rem
Rem dmsvodem_n.sql
Rem
...
Rem    madhpand    07/25/16 - adding parallel hint
Rem    jiangzho    02/17/16 - fix a typo involving SVM
