Rem
Rem $Header: rdbms/demo/dmnnrdem.sql /main/1 2017/01/20 00:02:28 nihao Exp $
Rem
Rem dmnnrdem.sql
Rem
...
Rem
Rem    NAME
Rem      dmnnrdem.sql - Sample program for the DBMS_DATA_MINING package.
Rem
Rem    DESCRIPTION
Rem      This script creates a regression model using Neural Network
Rem      based on data in the SH (Sales History) schema in the RDBMS and
...
Rem    SQL_SOURCE_FILE: rdbms/demo/dmnnrdem.sql
Rem    SQL_SHIPPED_FILE: NONE
Rem    SQL_PHASE: NONE
