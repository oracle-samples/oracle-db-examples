Rem
Rem $Header: tk_datamining/tmdm/sql/dmrfdemo_n.sql /main/1 2017/03/30 01:47:03 gayyappa Exp $
Rem
Rem dmrfdemo.sql
Rem
...
Rem
Rem    NAME
Rem      dmrfdemo.sql - Sample program for the DBMS_DATA_MINING package
Rem
Rem    DESCRIPTION
Rem      This script creates a classification model
Rem      using the Random Forest algorithm
