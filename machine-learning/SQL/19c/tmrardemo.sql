Rem
Rem $Header: rdbms/demo/dmrardemo.sql /main/2 2016/01/12 07:51:05 qinwan Exp $
Rem
Rem dmrardemo.sql
Rem
...
Rem
Rem    NAME
Rem      dmrardemo.sql - Sample program for ODM R Extensible
Rem
Rem    DESCRIPTION
Rem      This file uses R scripts and ODM R extensible to build an Association
Rem      Rules model in ODM framework
Rem
Rem    NOTES
Rem
Rem
