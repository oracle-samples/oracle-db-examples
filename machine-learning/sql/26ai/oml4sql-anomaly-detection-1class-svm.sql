...
BEGIN
  EXECUTE IMMEDIATE 'CREATE TABLE svmo_sh_sample_settings (setting_name VARCHAR2(30), setting_value VARCHAR2(4000))';
END;
/
...
-- These statistics are not influenced by outliers and are likely to
-- provide a more accurate picture of the population of interest than
...
-- automatically during model scoring since the model was built with
-- auto data prep.
--
