...
-- BEGIN
--   DBMS_DATA_MINING.DROP_MODEL('CUSTOMERS360MODEL_AD');
--   EXCEPTION WHEN OTHERS THEN NULL;
-- END;
-- /

-- BEGIN
--   EXECUTE IMMEDIATE 'DROP VIEW DEMOGRAPHICS_V';
--   EXCEPTION WHEN OTHERS THEN NULL;
-- END;
-- /

-- BEGIN
--   EXECUTE IMMEDIATE 'DROP VIEW CUSTOMERS360_V';
--   EXCEPTION WHEN OTHERS THEN NULL;
-- END;
-- /

-- BEGIN
--   EXECUTE IMMEDIATE 'DROP VIEW EM_ANOMALOUS_RESULTS';
--   EXCEPTION WHEN OTHERS THEN NULL;
-- END;
-- /
