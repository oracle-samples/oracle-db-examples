...
BEGIN
  DBMS_DATA_MINING.DROP_MODEL('OC_SH_Clus_sample');
...
BEGIN
  ...
  v_setlst(dbms_data_mining.algo_name) := dbms_data_mining.algo_ocluster;
  v_setlst(dbms_data_mining.clus_num_clusters) := '10';
...
BEGIN
  EXECUTE IMMEDIATE 'DROP TABLE oc_sh_sample_settings';
  EXCEPTION WHEN OTHERS THEN NULL;
END;
/
BEGIN
...
BEGIN
  EXECUTE IMMEDIATE 'CREATE TABLE oc_sh_sample_settings (setting_name VARCHAR2(30), setting_value VARCHAR2(4000))';
END;
/

BEGIN
INSERT INTO oc_sh_sample_settings (setting_name, setting_value) VALUES
...
-- Assign 5 customers to clusters, and provide explanations for the assignments.
--
