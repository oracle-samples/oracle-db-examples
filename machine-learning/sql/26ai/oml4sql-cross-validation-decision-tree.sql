...
-- Training data can be parameterized for general usage
...
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE dmdtxvld_c';
...
BEGIN
    EXECUTE IMMEDIATE 'DROP VIEW XVLD_TMP_BLD_V';
    EXCEPTION WHEN OTHERS THEN NULL;
END;

BEGIN
    EXECUTE IMMEDIATE 'DROP VIEW XVLD_TMP_TST_V';
    EXCEPTION WHEN OTHERS THEN NULL;
END;END;
/
...
-- Create the settings table before the cross-validation loop.
BEGIN
...
-- BEGIN
--   DBMS_DATA_MINING.DROP_MODEL('DT_SH_CLAS_XVLD_TMP');
--   EXCEPTION WHEN OTHERS THEN NULL;
-- END;
-- /
...
-- BEGIN
--   EXECUTE IMMEDIATE 'DROP TABLE MINING_DATA_BUILD_V_P';
--   EXCEPTION WHEN OTHERS THEN NULL;
-- END;
-- /
