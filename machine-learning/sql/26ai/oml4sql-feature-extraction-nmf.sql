...
BEGIN
  DBMS_DATA_MINING.DROP_MODEL('NMF_SH_sample');
...
BEGIN
  EXECUTE IMMEDIATE 'DROP TABLE nmf_sh_sample_settings';
  EXCEPTION WHEN OTHERS THEN NULL;
END;
/
BEGIN
...
BEGIN
  EXECUTE IMMEDIATE 'CREATE TABLE nmf_sh_sample_settings (setting_name VARCHAR2(30), setting_value VARCHAR2(4000))';
END;
/
