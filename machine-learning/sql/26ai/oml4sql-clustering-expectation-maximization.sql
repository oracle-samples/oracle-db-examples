...
BEGIN
  v_setlst(dbms_data_mining.algo_name) := dbms_data_mining.algo_expectation_maximization;
...
BEGIN
  EXECUTE IMMEDIATE 'DROP TABLE em_sh_sample_settings';
  EXCEPTION WHEN OTHERS THEN NULL;
END;
/
BEGIN
...
BEGIN
  EXECUTE IMMEDIATE 'CREATE TABLE em_sh_sample_settings (setting_name VARCHAR2(30), setting_value VARCHAR2(4000))';
END;
/
