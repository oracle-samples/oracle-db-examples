...
public class BookingController {
     ...
     */
    @PostMapping
    public ResponseEntity<StartTransactionResponseDTO> startTransaction(@RequestBody StartTransactionRequestDTO body) {

        StartTransactionResponseDTO response = bookingService.startTransaction(body);
    ...
    public ResponseEntity<RequestTicketsResponseDTO> requestTickets(@PathVariable Long bookingId,
                                                                    @RequestBody RequestTicketsRequestDTO body) {
        RequestTicketsResponseDTO response = bookingService.requestTickets(bookingId, body);
    ...
    public ResponseEntity<Void> removeTicket(@PathVariable Long bookingId,
                                              @RequestBody RemoveTicketRequestDTO body) {
