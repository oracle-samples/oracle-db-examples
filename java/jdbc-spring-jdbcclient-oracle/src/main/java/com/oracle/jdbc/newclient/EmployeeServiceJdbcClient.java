...
public class EmployeeServiceJdbcClient implements EmployeeService {
  ...
  private static final Logger log = LoggerFactory
      .getLogger(EmployeeServiceJdbcClient.class);
  ...
  public Optional<Employee> findById(String id) {
    return jdbcClient.sql(EmployeeSqlStatements.FIND_EMPLOYEE_BY_ID.statement())
        .param(EmployeeSqlStatements.ID.statement(), id).query(Employee.class)
        .optional();
  }
  ...
  public void create(Employee employee) {
    var updated = jdbcClient
        .sql(EmployeeSqlStatements.CREATE_NEW_EMPLOYEE.statement())

        .params(List.of(employee.id(), employee.name(), employee.role(),
  ...
  public void update(Employee employee, String id) {
    var updated = jdbcClient
        .sql(EmployeeSqlStatements.UPDATE_EMPLOYEE.statement())
        .params(List.of(employee.name(), employee.role(), employee.salary(),
  ...
  public void delete(String id) {
    var updated = jdbcClient
        .sql(EmployeeSqlStatements.DELETE_EMPLOYEE.statement()).param(id, id)
        .update();
