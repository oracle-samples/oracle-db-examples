...
exec select '&1' into :stsname from dual;
exec select '&2' into :samp from dual;
exec select decode(nvl(upper('&3'),'N'),'N','N','Y') into :create_now from dual;
